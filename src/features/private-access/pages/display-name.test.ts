...
import { looksLikeContactDetail, safeDisplayName } from './AccessManagementPage'
...
describe('safeDisplayName', () => {
  it('returns the default label for empty / null', () => {
  ...
  it('masks any stored value that looks like contact info', () => {
